...
public class Config {
    ...
    public static class Logging {
         ...
         */
        public String getFatalLogChannelId() {
            return fatalLogChannelId;
        }

        /**
         * @param fatalLogChannelId Channel ID to set for fatal bot errors
         */
        public void setFatalLogChannelId(String fatalLogChannelId) {
            this.fatalLogChannelId = fatalLogChannelId;
        }
    }
    ...
    public static class Voting {
         ...
         */
        public String getSuggestions_forum_id() {
            return suggestions_forum_id;
        }

        /**
         * @param suggestions_forum_id Forum ID to set for suggestions
         */
        public void setSuggestions_forum_id(String suggestions_forum_id) {
            this.suggestions_forum_id = suggestions_forum_id;
        }
    }
    ...
    public static class BugReport {
         ...
         */
        public String getBugReport_forum_id() {
            return bugReport_forum_id;
        }

        /**
         * @param bugReport_forum_id Forum ID to set for bug reports
         */
        public void setBugReport_forum_id(String bugReport_forum_id) {
            this.bugReport_forum_id = bugReport_forum_id;
        }
    }
    ...
    public static class Support {
         ...
         */
        public String getSupport_forum_id() {
            return support_forum_id;
        }

        /**
         * @param support_forum_id Forum ID to set for support requests
         */
        public void setSupport_forum_id(String support_forum_id) {
            this.support_forum_id = support_forum_id;
        }
    }
    ...
    public static class Faq {
         ...
         */
        public String getFaq_channel_id() {
            return faq_channel_id;
        }

        /**
         * @param faq_channel_id Channel ID to set for FAQ
         */
        public void setFaq_channel_id(String faq_channel_id) {
            this.faq_channel_id = faq_channel_id;
        }

        /**
         * @return Array of FAQ entries
         */
        public FaqEntry[] getFaq_entries() {
            return faq_entries;
        }
         ...
         */
        public void setFaq_entries(FaqEntry[] faq_entries) {
            this.faq_entries = faq_entries;
        }
    }
